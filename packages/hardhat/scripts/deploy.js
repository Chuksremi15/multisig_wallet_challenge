...
const main = async () => {
  ...
  const MetaMultiSigWallet = await deploy("MetaMultiSigWallet", [
    31337,
    ["0x62d77aF1c22277D227269ceC3868c59471c0f9ed"],
    1,
  ]);

  //const yourContract = await deploy("YourContract") // <-- add in constructor args like line 19
  const Monyo = await deploy("Monyo", [
